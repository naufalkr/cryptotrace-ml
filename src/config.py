...
for dir_path in [RAW_DATA_DIR, PROCESSED_DATA_DIR, MODELS_DIR, REPORTS_DIR, FIGURES_DIR]:
...
RISK_SCORED_CSV_PATH = PROCESSED_DATA_DIR / "wallet_risk_scored_final.csv"
RISK_SCORED_JSON_PATH = PROCESSED_DATA_DIR / "risk_scores_final.json"
